...
Begin VB.MDIForm MDIFarmacia 
   ...
   Begin MSComctlLib.StatusBar StaBarEmp 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel4 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            Object.Width           =   4410
            MinWidth        =   4410
            Picture         =   "MDIFarmacia.frx":28A86
            Key             =   "Periodo"
         EndProperty
         BeginProperty Panel5 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            Picture         =   "MDIFarmacia.frx":29360
            Key             =   "Plataforma"
         EndProperty
      EndProperty
   ...
   Begin VB.Menu BaseRel 
      ...
      Begin VB.Menu MDelSistema 
         ...
         End
         Begin VB.Menu MXMLSRI 
            Caption         =   "Solicitudes del SRI en XML "
         End
         Begin VB.Menu MSetImp 
            Caption         =   "Impresora &Prederminada"
         End
   ...
   Begin VB.Menu Reportes 
      ...
      End
      Begin VB.Menu MNotaEgreInv 
         Caption         =   "Imprimir Nota Salida Producto"
      End
      Begin VB.Menu MBar2 
         Caption         =   "-"
      End
...
Private Sub MCambioPeriodo_Click()
  If ClaveContador Then
     ...
     PonerDirEmpresa MDIFact, Modulo
  End If
End Sub
...
Private Sub MDIForm_Load()
 ...
 'MODULOS
  ...
  Select Case Ambiente
    Case "1": MDIFact.MAmbiente.Caption = "A M B I E N T E   D E   P R U E B A"
    Case "2": MDIFact.MAmbiente.Caption = "A M B I E N T E   E N   P R O D U C C I O N"
    Case Else: MDIFact.MAmbiente.Caption = ""
  End Select
  PonerDirEmpresa MDIFact, Modulo
End Sub
...
Private Sub MFormaDePago_Click()
  RatonReloj
  FFormaDePago.Show
End Sub
...
Private Sub MNotaEgreInv_Click()
  RatonReloj
  NotaEgreso.Show
End Sub
...
Private Sub MSetImp_Click()
  RatonReloj
  Seteos_de_la_Impresora
End Sub
...
Private Sub ProcOtraEmp_Click()
  ...
  IngresarClave = False
  ListEmp.Show 1
  PonerDirEmpresa MDIFact, "FACTURACION"
End Sub
