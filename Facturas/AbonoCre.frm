...
Begin VB.Form AbonoCredito 
   ...
   Begin MSAdodcLib.Adodc AdoDetAcomp 
      ...
      _Version        =   393216
   End
   Begin MSDataListLib.DataCombo DCCredito 
      Bindings        =   "AbonoCre.frx":0D56
      DataSource      =   "AdoCredito"
      Height          =   315
      Left            =   105
      TabIndex        =   29
      Top             =   1995
   ...
   Begin VB.Label Label12 
      ...
      Caption         =   " CUOTAS PENDIENTES DEL CREDITO"
      Height          =   330
      Left            =   105
      TabIndex        =   30
      Top             =   1680
   ...
   End
End
Attribute VB_Name = "AbonoCredito"
...
Private Sub Command2_Click()
   Control_Procesos Normal, "Salir de abonos de facturas por creditos"
   Unload Me
End Sub
      ...
      .Find ("Factura = " & Val(DCFactura) & " ")
       If Not .EOF Then
         ...
         'Datos del Abonos
          ...
          LabelPend.Caption = Format(SaldoDisp, "#,##0.00")
          AbonoCredito.Caption = "INGRESO DE CAJA (" & TipoFactura & ")"
          
          sSQL = "SELECT (Fecha & ' ' & Credito_No & ' ' & Pagos) As Creditos " _
               & "FROM Trans_Prestamos " _
               & "WHERE Item = '" & NumEmpresa & "' " _
               & "AND TP = '" & TA.TP & "' " _
               & "AND Cta = '" & TA.Cta_CxP & "' " _
               & "AND Cuenta_No = '" & TA.CodigoC & "' " _
               & "AND Credito_No = '" & Format(TA.Factura, "0000000") & "' "
          SelectDBCombo DCCredito, AdoCredito, sSQL, "Creditos"
