         ...
         'C.Email,C.Fecha_N,C.Codigo,R.Grupo_Rol,CR.Codigo_Banco
          If Len(.fields("Cta_Transferencia")) > 4 Then
           ...
           ' Empieza la trama por Alumno
             ...
             Traza = Traza & Codigo2                             ' Número de Cuenta Banco Guayaquil
             Traza = Traza & ValorStrg                           ' ValoR
             Traza = Traza & "XX"                                ' Motivo
             Traza = Traza & "Y"                                  ' Tipo de Nota
             Traza = Traza & "01"                                ' Agencia
             Traza = Traza & Codigo4                             ' Código de banco para el pago interbancario
             Traza = Traza & Codigo3                             ' Número de Cuenta Otros Bancos
             ...
             Traza = Traza & CodigoP                             ' Número Identificación Beneficiario
