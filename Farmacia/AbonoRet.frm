...
Public Sub GrabarAbonosRetenciones(CtaCierre As String, _
  ...
  If Valor > 0 Then
     ...
     SetAdoFields "Banco", UCase(DetalleCta) '
...
Private Sub Command1_Click()
  ...
  If BoxMensaje = vbYes Then
     ...
     End If
     Codigo1 = Format(Val(Trim(Mid(TextCheqNo, 1, 3))), "000")
     Codigo2 = Format(Val(Trim(Mid(TextCheqNo, 4, 3))), "000")
...
Private Sub TextBanco_LostFocus()
  TextoValido TextBanco
  TextBanco = Format(Val(TextBanco), "0000000000")
End Sub
