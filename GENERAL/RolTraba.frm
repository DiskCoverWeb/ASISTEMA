...
Dim Separador As String
 ...
 'Abrimo los archivo que vamos ha necesitar
  Traza = Year(MBFechaI) & "-" & UCase(Mid$(MesesLetras(Month(MBFechaI)), 1, 3)) & "-" & Format(Day(MBFechaI), "00")
      ...
      .MoveFirst
       Do While Not .EOF
          If Len(.Fields("CI_RUC")) = 10 Then
             ...
             NombreCliente = Trim$(Mid$(NombreCliente, Len(Codigo1) + 1, Len(NombreCliente)))
             Codigo2 = SinEspaciosIzq(NombreCliente)
             NombreCliente = Trim$(Mid$(NombreCliente, Len(Codigo2) + 1, Len(NombreCliente)))
           ...
           ' Empieza la trama por Alumno
             ...
             Print #NumFileAlumnos, Trim$(Codigo3) & ";";
             Print #NumFileAlumnos, Trim$(Codigo1 & " " & Codigo2) & ";"
          End If
         .MoveNext
       Loop
   End If
...
Dim Separador As String
 ...
 'Abrimo los archivo que vamos ha necesitar
  Select Case Decimo
    Case 3: Traza = "Decimo_3ro-" & Year(MBFechaI) & "-" & UCase(Mid$(MesesLetras(Month(MBFechaI)), 1, 3))
    Case 4: Traza = "Decimo_4to-" & Year(MBFechaI) & "-" & UCase(Mid$(MesesLetras(Month(MBFechaI)), 1, 3))
  End Select
           ...
           ' Empieza la trama por Empleado
             Select Case Decimo
               Case 3
                     ...
                     Print #NumFileAlumnos, Trim$(Codigo3) & ";";
                     Print #NumFileAlumnos, Trim$(Codigo1 & " " & Codigo2) & ";";
                     Print #NumFileAlumnos, Trim$(.Fields("Sexo")) & ";";
