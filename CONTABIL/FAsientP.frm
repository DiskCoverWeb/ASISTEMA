  ...
  Else
     ...
     With AdoSubCta.Recordset
      If .RecordCount > 0 Then
          ...
          Total = .Fields("Pagos")
          Saldo = Round(Val(TxtCant.Text), 2)
          Codigo1 = SinEspaciosIzq(DLBanco.Text)
          Codigo2 = SinEspaciosIzq(DLCtas.Text)
...
Private Sub Command7_Click()
  Control_Procesos Normal, "Intereses Ganados del " & MBFechaI.Text
  FechaIni = BuscarFecha(MBFechaI.Text)
  SumaDebe = 0: SumaHaber = 0
       ...
       If Round(SumaDebe - SumaHaber, 2) = 0 Then
          ...
          If Nuevo Then
             SQL2 = "UPDATE Trans_Prestamos " _
                  & "SET AC = " & Val(adTrue) & ",T = 'C'," _
                  & "Fecha_C = #" & BuscarFecha(Mifecha) & "#," _
                  & "Numero = " & Co.Numero & " " _
...
Private Sub Form_Activate()
  ...
  FechaIni = BuscarFecha(MBFechaI.Text)
  IniciarAsientosDe DGAsiento, AdoAsiento
  sSQL = "SELECT Codigo & Space(3) & Cuenta As Nombre_Cta " _
       & "FROM Catalogo_Cuentas " _
       & "WHERE Item = '" & NumEmpresa & "' " _
       & "AND Periodo = '" & Periodo_Contable & "' " _
       & "AND TC = 'CP' " _
       & "ORDER BY Codigo "
  SelectDBList DLTP, AdoTP, sSQL, "Nombre_Cta"
  sSQL = "SELECT Codigo & Space(3) & Cuenta As Nombre_Cta " _
       & "FROM Catalogo_Cuentas " _
       & "WHERE Item = '" & NumEmpresa & "' " _
       & "AND Periodo = '" & Periodo_Contable & "' " _
       & "AND TC = 'BA' " _
       & "ORDER BY Codigo "
  SelectDBList DLBanco, AdoBanco, sSQL, "Nombre_Cta"
  sSQL = "SELECT Codigo & Space(3) & Cuenta As Nombre_Cta " _
       & "FROM Catalogo_Cuentas " _
       & "WHERE Item = '" & NumEmpresa & "' " _
       & "AND Periodo = '" & Periodo_Contable & "' " _
...
Private Sub TxtDep_KeyDown(KeyCode As Integer, Shift As Integer)
 PresionoEnter KeyCode
End Sub
