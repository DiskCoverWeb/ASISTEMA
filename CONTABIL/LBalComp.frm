...
Private Sub Command3_Click()
  ...
  sSQL = sSQL _
       ...
       & "ORDER BY Cta,T.Fecha,T.TP,T.Numero,Debe DESC,Haber,ID "
  ...
  Select Case KeyCode
    ...
    Case vbKeyF10
         If ClaveAuxiliar Then
            FechaComp = DGBanco.Columns(1).Text
            TipoComp = DGBanco.Columns(2).Text
            NumComp = DGBanco.Columns(3).Text
            NumItem = NumEmpresa
            NumeroComp = NumComp
...
Private Sub Form_Activate()
  ...
  SelectDBCombo DCAgencia, AdoAgencias, sSQL, "NomEmpresa"
  ...
  sSQL = "SELECT Codigo & Space(20) & Cuenta As Nombre_Cta " _
       ...
       & "ORDER BY Codigo "
  SelectDBCombo DCCtas, AdoBanco1, sSQL, "Nombre_Cta", False
  ...
  SelectDBCombo DCUsuario, AdoUsuario, sSQL, "CodUsuario", False
